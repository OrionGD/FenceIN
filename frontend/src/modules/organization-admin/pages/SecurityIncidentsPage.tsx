  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Security Incidents</h1>
          <p className="text-slate-400 mt-1">Manage and view security incidents for the organization admin module.</p>
        </div>
