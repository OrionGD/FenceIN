...
export const viewSchedule = async (payload: any) => {
  try {
    ...
    return {
      success: true,
      message: 'view schedule completed successfully.',
      data: payload
    };
  } catch (error: any) {
    console.error('[Action] Error in viewSchedule:', error);
    return {
      success: false,
